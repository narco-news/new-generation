...
<template>
  <section class="opinion-wrapper">
    <div class="opinion__header-wrapper">
    ...
    <div class="opinion__articles-wrapper">
      <article v-for="article in props.articles" :key="article.slug" class="opinion__article">
